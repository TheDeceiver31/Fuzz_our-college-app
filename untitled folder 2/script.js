...
// Add click event to each button to show the corresponding details section
detailsButtons.forEach((button, index) => {
    button.addEventListener('click', () => {
        eventDetailsSections[index].classList.add('active'); // Show the corresponding details
    });
});
